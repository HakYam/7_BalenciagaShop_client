        ...
        <div className='categories'>
            <div className='col'>
                <div className='row'>
                    ...
                    <button>
                        <Link className='link' to={'/category/1'}>Summer</Link>
                    </button>
                </div>
                <div className='row'>
                    ...
                    <button>
                        <Link className='link' to={'/category/1'}>Women</Link>
                    </button>
                </div>
            </div>
            <div className='col'>
                <div className='row'>
                    ...
                    <button>
                        <Link className='link' to={'/category/1'}>New Collection</Link>
                    </button>
                </div>
            </div>
            <div className='col col-l'>
                <div className='row'>
                    <div className='col'>
                        <div className='row'>
                            ...
                            <button>
                                <Link className='link' to={'/category/1'}>Special</Link>
                            </button>
                        </div>
                    </div>
                    <div className='col'>
                        <div className='row'>
                            ...
                            <button>
                                <Link className='link' to={'/category/1'}>Sale</Link>
                            </button>
                        </div>
                    </div>
                </div>
                <div className='row'>
                    ...
                    <button>
                        <Link className='link' to={'/category/1'}>Balenciaga</Link>
                    </button>
                </div>
            </div>
        </div>
